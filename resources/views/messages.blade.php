...
@section('content')
    ...
    <div class="flex-1 p:2 sm:p-6 justify-between flex flex-col h-screen" style="margin-top: 4rem">
        ...
        <div id="messages" class="flex flex-col space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch">
            <div id="messages" class="flex flex-col space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch">
                <div id="messages" class="flex flex-col space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch">
                    @foreach($messages as $message)
                        <div class="chat-message {{ $message->sender_id == Auth::id() ? 'from-sender' : 'from-recipient' }}">
         ...
         <span class="absolute inset-y-0 flex items-center">
            ...
            <form action="{{ route('send.message', $user->id) }}" method="post">
                    @csrf
                <input type="text" placeholder="Write your message!" name="content" class="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-12 bg-gray-200 rounded-md py-3">
